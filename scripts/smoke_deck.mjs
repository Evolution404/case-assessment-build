...
try{
 ...
 if(await page.locator('.slide').count()!==15)throw new Error('slide count');await page.keyboard.press('ArrowRight');await page.waitForFunction(()=>document.querySelector('.slide.active')?.dataset.no==='02');
