...
("4:00—5:35","全省地图交互演示","依次点击“交叉跨越”“防鸟”“燃放点”，每次停留约20秒","先看交叉跨越。程序先用包围盒排除不可能相交的组合，再做精确求交，把候选点直接标出来。再看防鸟，利用GBIF鸟类活动记录并结合公开生态资料形成重点活动区域，再与输电线路叠加，筛出需要外协重点核验的线路区段。最后看燃放点，围绕点位生成N米缓冲区，批量筛出周边杆塔。人的工作从全量寻找变成候选核验，这就是增效。"),
...
("6:55—7:40","增质：照片查重强化外协履职质量监督","从增效转入提质","接下来讲增质。外协工单和巡视照片是证明到位、处置和履职的重要依据。人工能看清一张照片，却记不住成千上万张历史照片。照片经过裁剪、调色、旋转甚至局部消除后，更难靠肉眼发现。增质的关键，是把外协质量监督从有限抽查变成机器全量筛选、管理人员重点复核。"),
